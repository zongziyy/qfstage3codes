...
<el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
  ...
  <el-form-item :label="$t('lang.userpwd')" prop="pass">
    <el-input type="password" v-model="ruleForm.pass" autocomplete="on"></el-input>
  </el-form-item>

  <el-form-item>
    <el-button type="primary" @click="submitForm('ruleForm')">{{$t('lang.submit')}}</el-button>
    <el-button @click="resetForm('ruleForm')">{{$t('lang.reset')}}</el-button>
  </el-form-item>
</el-form>
</div>
</template>
